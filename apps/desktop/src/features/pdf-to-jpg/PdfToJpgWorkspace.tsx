...
export function PdfToJpgWorkspace({ onBack }: { onBack: () => void }) {
  ...
  return (
    <WorkspaceLayout title="PDF to JPG" onBack={onBack}>
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-slate-400">Every page exports as one JPG image. Higher DPI means larger files.</p>
      </section>
